...
export default function AboutPage() {
  ...
  return (
    <PageShell title={t.about_legal || "About & Legal"} transparent>
      <div className="grid gap-4 max-w-4xl mx-auto pb-8">
        ...
        >
          <div className="about-page-heading text-lg md:text-xl font-black text-amber-400 border-b border-amber-500/30 pb-3 mb-3">About Hindu Calendar</div>
          <div className="text-sm md:text-base text-amber-100/90 leading-relaxed space-y-3">
            <p>Built as a comprehensive Hindu calendar dashboard with locally computed astrology data for fast, dependable results.</p>
            <p>Access Panchang, festivals, muhurat, kundali, matchmaking, and more. Data is generated inside the app and optimized for performance.</p>
          </div>
        </section>
        ...
        <section
          ...
          style={{ background: "transparent", backdropFilter: "none", WebkitBackdropFilter: "none" }}
        >
          <div className="about-page-heading text-lg md:text-xl font-black text-amber-400 border-b border-amber-500/30 pb-3 mb-3">Tips for Best Use</div>
        ...
        <section
          ...
          style={{ background: "transparent", backdropFilter: "none", WebkitBackdropFilter: "none" }}
        >
          <div className="about-page-heading text-lg md:text-xl font-black text-amber-400 border-b border-amber-500/30 pb-3 mb-3">Terms & Conditions</div>
          <div className="text-sm md:text-base text-amber-100/90 leading-relaxed space-y-3">
        ...
        <section
          ...
          style={{ background: "transparent", backdropFilter: "none", WebkitBackdropFilter: "none" }}
        >
          <div className="about-page-heading text-lg md:text-xl font-black text-amber-400 border-b border-amber-500/30 pb-3 mb-3">Privacy Policy</div>
          <div className="text-sm md:text-base text-amber-100/90 leading-relaxed space-y-3">
            <p>We respect your privacy. This application does not collect, store, or transmit unnecessary personal data.</p>
            <p>Location data (if provided) is used strictly locally to calculate accurate, location-based astronomical data like sunrise and tithi. It is not tracked, stored, or sold to third parties.</p>
        ...
        {/* Disclaimers & Contact */}
        <section
          className="app-surface rounded-3xl p-5 md:p-6 text-amber-50 shadow-lg border border-red-500/20 bg-gradient-to-br from-black/20 to-red-900/10"
          style={{ background: "transparent", backdropFilter: "none", WebkitBackdropFilter: "none" }}
        >
          <div className="about-page-heading text-lg md:text-xl font-black text-amber-400 border-b border-amber-500/30 pb-3 mb-3">Data Disclaimer & Feedback</div>
          <div className="text-sm md:text-base text-amber-100/90 leading-relaxed space-y-3">
            <p><strong>Informational Purposes Only:</strong> The calendar, astrological data, horoscopes, and time calculations provided by this application are generated from local astronomical algorithms. We <strong>do not guarantee</strong> the absolute accuracy, completeness, or reliability of this data.</p>
