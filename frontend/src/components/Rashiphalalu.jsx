  ...
  return (
    ...
    >
      ...
      <main className="relative z-10 mx-auto max-w-5xl px-2 py-2 space-y-3">
        ...
        <div
          className="rounded-2xl sm:rounded-3xl p-5"
          style={{
            background: "transparent",
            border: SHARED_BORDER,
            boxShadow: "none",
          ...
          <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-3">
            {RASHIS.map((rashi) => (
              <button
                ...
                className={`rounded-xl p-3 transition-all hover:scale-105 ${selectedRashi.id === rashi.id ? "scale-[1.03]" : ""}`}
                style={{
                  background:
                    selectedRashi.id === rashi.id
                      ? "linear-gradient(180deg, rgba(255, 214, 102, 0.26) 0%, rgba(255, 183, 77, 0.14) 100%)"
                      : "transparent",
                  border: selectedRashi.id === rashi.id
                    ? "2px solid rgba(255, 214, 102, 0.95)"
                    : SHARED_BORDER,
                  boxShadow: selectedRashi.id === rashi.id
                    ? "0 0 0 2px rgba(255, 214, 102, 0.22), inset 0 0 24px rgba(255, 214, 102, 0.12)"
                    : "none",
        ...
        < div
          className="rounded-2xl sm:rounded-3xl p-6 -mt-3"
          style={{
            background: "transparent",
            border: SHARED_BORDER,
            boxShadow: "none",
