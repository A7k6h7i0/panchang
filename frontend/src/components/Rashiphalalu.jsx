...
const getRashiphalaluData = (rashiId, language) => {
  const data = {
    ...
    karka: {
      ...
      ml: { general: "കുടുംബ സമയം നിങ്ങൾക്ക് സമാധാനവും സന്തോഷവും നല്‍കും.", luckyColor: "വെള്ಳಿ", luckyNumber: 2 },
    ...
    kanya: {
      ...
      ml: { general: "ഇന്ന് ആരോഗ്യത്തിലും ക്ഷೇಮತ್ತಿಲುಂ ಶ್ರದ್ಧ ಕೊಡುಕ.", luckyColor: "വെള്ള", luckyNumber: 4 },
    ...
    tula: {
      ...
      ml: { general: "ഇന്ന് സന്തുലിതാವಸ್ಥಯುಂ ಸಾಮರಸ್ಯವುಂ ನಿಙ್ಙಳುಟೆ ಶ್ರದ್ಧ.", luckyColor: "പിങ്ക്", luckyNumber: 6 },
    ...
    vrishchika: {
      ...
      ml: { general: "ഇന്ന് നിങ്ങളുടെ അന്തര്‍ദృಷ್ಟಿಕ್ಕು ವಿಶ್ವಾಸಮರ್ಪಿಕ್ಕು.", luckyColor: "ഇരുണ്ട ചുവപ്പ്", luckyNumber: 8 },
    ...
    dhanu: {
      ...
      ml: { general: "സാഹസിಕತಯುಂ ಪುತಿಯ ಅನುಭವವುಂ ನಿಙ್ಙಳ്‍ಕಾಯಿ ಕಾತ್ತಿರಿಕ್ಕುನ್ನು.", luckyColor: "ഓറഞ്ച്", luckyNumber: 9 },
    ...
    makara: {
      ...
      ml: { general: "കഠിനാധ್ವಾನಂ ಮಿಕಚ್ಚ ಪ್ರತಿಫಲಂ ನಲ್ಲಕು.", luckyColor: "തവിട്ട്", luckyNumber: 10 },
    ...
    kumbha: {
      ...
      ml: { general: "കണ്ടുപിടಿತ್ತವುಂ ಸಮರ್ಥವುಂ ವಿಜಯಂ ನಲ್ಲಕು.", luckyColor: "നീല", luckyNumber: 11 },
    ...
    meena: {
      ...
      ml: { general: "ആത്മനಿಷ್ಠ ಶ್ರಮಙ್ಙಳ്‍ ആഭ್ಯನ್ತರ ಸമാಧാನം ನല്‍കും.", luckyColor: "പർപ്പിള്‍", luckyNumber: 12 },
