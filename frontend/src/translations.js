export const translations = {
  ...
  te: {
    ...
    varjyam: "వర్జ్యం",
    alarmSettings: "ముహూర్తం అలారం సెట్టింగ్లు",
    ...
    silentModeHint: "ఆడియో సెట్టింగ్‌ను పైచేయి చేస్తుంది",
    reminderTime: "రిమైండర్ సమయం",
    minutesBeforeStart: "ప్రారంభానికి ముందు నిమిషాలు",
    disabledDays: "డిసేబుల్ చేసిన రోజులు",
