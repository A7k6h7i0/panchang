export const translations = {
  ...
  ml: {
    ...
    appSubtitle: "തിഥിയും നക్షത്രവുമുള്ള ഹിന്ദു കലണ്ടർ",
    calendar: "കലണ്ടർ",
   ...
   varjyam: "വർജ്യം",
    ...
    Shoola: "ശൂല", Ganda: "ഗണ്ഡ", Vriddhi: "വൃദ్ధി", Dhruva: "ധ്രുവ",
    Vyaghata: "വ്യാഘാത", Harshana: "ഹർഷണ", Vajra: "വജ്ര", Siddhi: "സിദ്ധി",
    Vyatipata: "വ്യതീപാത", Variyana: "വരിയാൻ", Parigha: "പരിഘ", Shiva: "ശിവ",
    Siddha: "സിദ്ധ", Sadhya: "സാധ്യ", Shubha: "ശുഭ", Shukla: "ശుక്ല",
    Brahma: "ബ്രഹ്മ", Indra: "ഇന്ദ്ര", Vaidhriti: "വൈധృതി",
