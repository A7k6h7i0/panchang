export const translations = {
  en: {
    appTitle: "Talking Hindu Calendar",
  ...
  te: {
    appTitle: "మాట్లాడు హిందూ క్యాలెండర్",
  ...
  hi: {
    appTitle: "बोलने वाला हिंदू कैलेंडर",
    ...
    selectDate: "विवरण देखने के लिए एक तिथि चुनें।",
...
varjyam: "वर्ज्यम्",
  ...
  ml: {
    appTitle: "സംസാരിക്കുന്ന ഹിന്ദു കലണ്ടർ",
    ...
    builtWith: "React + Tailwind ഉപയോഗിച്ച് നിർമ്മിച്ചത് • ഹിന്ദു പഞ്ചാംഗം കലണ്ടർ •",
    today: "ഇന്ന്",
    
    panchangElements: "പഞ്ചാംഗ ഘടകങ്ങൾ",
    sunMoonTimings: "സൂര്യ & ചന്ദ്ര സമയങ്ങൾ",
    muhurtaTimings: "മുഹൂർത്ത സമയങ്ങൾ",
...
varjyam: "വർജ്യം",
    ...
    Anuradha: "അനിഴം", Jyeshtha: "തൃക്കേട്ട", 
    Moola: "മൂലം",
    Mula: "മൂലം",
    "Purva Ashadha": "പൂരാടം",
    "Uttara Ashadha": "ഉത്രാടം", Shravana: "തിരുവോണം", Dhanishta: "അവിട്ടം", Shatabhisha: "ചതയം",
    "Purva Bhadrapada": "പൂരുരുട്ടാതി", "Uttara Bhadrapada": "ഉത്രട്ടാതി", Revati: "രേവതി",
    
    Vishkambha: "വിഷ്കംഭ",
    Vishkumbha: "വിഷ്കംഭ",
    Priti: "പ്രീതി", Ayushman: "ആയുഷ്മാൻ", Saubhagya: "സൗഭാഗ്യ",
    Shobhana: "ശോഭന", Atiganda: "അതിഗണ്ഡ", Sukarma: "സുകർമ്മ", Dhriti: "ധൃതി",
    Shoola: "ശൂല", Ganda: "ഗണ്ഡ", Vriddhi: "വൃദ്ധി", Dhruva: "ധ്രുവ",
    Vyaghata: "വ്യാഘാത", Harshana: "ഹർഷണ", Vajra: "വജ്ര", Siddhi: "സിദ്ധി",
    Vyatipata: "വ്യതീപാത", Variyana: "വരിയാൻ", Parigha: "പരിഘ", Shiva: "ശിവ",
    Siddha: "സിദ്ധ", Sadhya: "സാധ്യ", Shubha: "ശുഭ", Shukla: "ശുക്ല",
    Brahma: "ബ്രഹ്മ", Indra: "ഇന്ദ്ര", Vaidhriti: "വൈധൃതി",
    ...
    monthsShort: ["ജനു", "ഫെബ്", "മാർ", "ഏപ്രി", "മെയ്", "ജൂൺ", "ജൂലൈ", "ഓഗ", "സെപ്", "ഒക്ട", "നവം", "ഡിസം"],
    weekdaysShort: ["ഞായർ", "തിങ്കൾ", "ചൊവ്വ", "ബുധൻ", "വ്യാഴം", "വെള്ളി", "ശനി"],
  },
  
  kn: {
    appTitle: "ಮಾತನಾಡುವ ಹಿಂದೂ ಕ್ಯಾಲೆಂಡರ್",
...
varjyam: "ವರ್ಜ್ಯಂ",
  ...
  ta: {
    appTitle: "பேசும் இந்து நாள்காட்டி",
